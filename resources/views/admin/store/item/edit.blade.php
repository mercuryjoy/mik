...
@section('main-content')
    {!! Form::model(new App\StoreItem, ['route' => ['admin.store.items.update', $item->id], 'method' => 'PUT', 'files' => true]) !!}
            ...
            <div class="box">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group{{ $errors->has('price_point') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('price_point', old('name', $item->price_point), ['class' => 'form-control']) !!}
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('is_virtual', ["1" => "是虚拟商品", "0"=> "不是虚拟商品"], old('is_virtual', $item->is_virtual), ['class' => 'form-control select2']) !!}
                    </div>
