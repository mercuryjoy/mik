...
@section('contentheader_title')
    采购商品管理 <a href="{{ route('admin.goods.items.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> 新建商品</a>
@endsection

@section('main-content')
    <div class='row'>
        <div class='col-md-12'>
            {!! Form::open(['route' => ['admin.goods.items.index'], 'method' => 'get']) !!}
            <div class="box">
                ...
                <div class="box-footer">
                    ...
                    <a class="btn btn-warning pull-right" href="{{ route("admin.goods.items.index") }}"><i class="fa fa-trash"></i> 清除过滤条件</a>
                </div>
            </div>
            {!! Form::close() !!}
        </div>
                                ...
                                <table class="table table-hover dataTable" role="grid">
                                    ...
                                    @foreach($items as $item)
                                        <tr role="row">
                                            ...
                                            <td>
                                                <a class="btn btn-xs btn-primary" href="{{ route('admin.goods.items.edit', ['id' => $item['id']]) }}">详情/修改</a>
                                                <a class="btn btn-xs btn-primary" href="{{ route('admin.goods.orders.index', ['item_id' => $item['id']]) }}">相关订单</a>
                                            </td>
                                        </tr>
                                    @endforeach
