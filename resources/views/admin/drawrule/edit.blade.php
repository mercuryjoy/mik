...
@section('breadcrumb')
    ...
    <li class="active">修改{{$rule->ruleTypeDisplay}}规则</li>
@endsection

@section('main-content')
    {!! Form::model(new App\DrawRule, ['route' => ['admin.drawrules.update', $rule->id], 'method' => 'PUT']) !!}
    ...
    <div class='row'>
        <div class='col-md-6'>
            <div class="box">
                ...
                <div class="box-body">
                    @if($rule->ruleType == 'area')
                        <div class="form-group{{ $errors->has('area_id') ? ' has-error' : '' }}">
                            {!! Form::label('area_id', '地区') !!}
                            {!! Form::text('area_id', old('area_id', $rule->area_id), ['class' => 'areapicker form-control hidden']) !!}
                    ...
                    @elseif($rule->ruleType == 'distributor')
                        <div class="form-group{{ $errors->has('distributor_id') ? ' has-error' : '' }}">
                            ...
                            {!! Form::text('distributor_id', old('distributor_id', $rule->distributor_id), ['class' => 'form-control']) !!}
                    ...
                    @elseif($rule->ruleType == 'shop')
                        <div class="form-group{{ $errors->has('shop_id') ? ' has-error' : '' }}">
                            ...
                            {!! Form::text('shop_id', old('shop_id', $rule->shop_id), ['class' => 'form-control']) !!}
                    ...
                    <div class="form-group{{ $errors->has('rule_json') ? ' has-error' : '' }}">
                        ...
                        {!! Form::text('rule_json', old('rule_json', $rule->rule_json), ['class' => 'form-control hidden']) !!}
